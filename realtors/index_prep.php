    ...
    <section id="blog" class="py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                $query = "SELECT title, image, excerpt FROM blog_posts";
                $result = mysqli_query($link, $query);
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<div class='col-md-4 mb-4'>
                            <div class='card'>
...
Sure, I'll restructure the provided `index.php` to closely match the Fanaka website while ensuring it integrates seamlessly with your backend.

Here is the updated `index.php`:
